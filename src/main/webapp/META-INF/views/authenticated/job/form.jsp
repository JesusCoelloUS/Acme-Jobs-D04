...
<input type="button" value="<spring:message code="authenticated.job.form.button.duties"/>" onclick="javascript:window.location.replace('/acme-jobs/authenticated/duty/list?id=${id}')">
